...
const privacyContent: Record<Language, { title: string; intro: string; updated: string; sections: PolicySection[] }> = {
  ...
  th: {
    ...
    sections: [
      ...
      {
        heading: 'โปรดปกป้องข้อมูลอ่อนไหว',
        paragraphs: ['โปรดอย่าส่งรหัสผ่าน ข้อมูลบัตรชำระเงิน เอกสารยืนยันตัวตน หรือข้อมูลอ่อนไหวอื่นที่ไม่จำเป็นผ่านเว็บไซต์หรือช่องทางการรับส่งข้อความของเรา Hemingways ไม่รับชำระเงินด้วยบัตรจากระยะไกล'],
      },
      {
  ...
  th: {
    ...
    sections: [
      ...
      },
      {
        heading: 'โปรดปกป้องข้อมูลอ่อนไหว',
        paragraphs: [
          'โปรดอย่าส่งรหัสผ่าน ข้อมูลบัตรชำระเงิน สำเนาหนังสือเดินทาง หรือเอกสารอ่อนไหวอื่นที่ไม่จำเป็น',
